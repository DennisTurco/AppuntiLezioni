...
int main() {
    ...
    // sanificazione dei valori non validi: default = 2
    ...
    up2.accodaUtente("Giovanni Fabbri", 1); // nome già presente allo sportello: non accoda

    cout << up2 << endl << endl << endl;

    cout << "Test serviUtente" << endl << endl;

    up2.serviUtente(3); // sportello troppo grande: non serve
    up2.serviUtente(1); // serve l'utente e svuota la coda
    up2.serviUtente(1); // coda vuota: non serve
    ...
    up2.accodaPrioritario("Giada Medici"); // nome già presente: non accoda
    ...
    up2.passaAvanti("Corrado Franchi", 1, -3); // numero negativo: fallisce

    cout << up2 << endl << endl << endl;

    cout << "Test operatore di negazione" << endl << endl;

    // due applicazioni consecutive lasciano up2 invariato
    !!up2;
